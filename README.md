...
Adjust input and output pathes to your needs. in [force-original.sh](originalWF/force-original.sh)
You will also need to adapt parallelization parameters in [force-l2ps-param.sh, ll. 28-30](originalWF/force-l2ps-param.sh) and [force-hlps-param.sh, ll. 22-24](originalWF/force-hlps-param.sh) to settings that will work on your machine.
```
